...
public class Cassandra3xMappings implements AttributeJMXRequestMapper {

    private final Logger logger = LoggerFactory.getLogger(Cassandra3xMappings.class);
    ...
    private final Map<AttributeType, JMXRequest> attributeMap = new HashMap<AttributeType, JMXRequest>() {{
        ...
        put(AttributeType.COMMIT_LOG, new JMXRequest.JMXRequestBuilder("org.apache.cassandra.db").type("Commitlog").attribute("ActiveOnDiskSize").build());
        ...
        put(AttributeType.READ_LATENCY_UNIT, new JMXRequest.JMXRequestBuilder("org.apache.cassandra.metrics").name("Latency").type("ClientRequest").scope("Read").attribute("DurationUnit").build());
        ...
        put(AttributeType.WRITE_LATENCY_UNIT, new JMXRequest.JMXRequestBuilder("org.apache.cassandra.metrics").name("Latency").type("ClientRequest").scope("Write").attribute("DurationUnit").build());
